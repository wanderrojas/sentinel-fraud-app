...
- Create Angular project with ng: `ng new reporteresultadosaep.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`reporteresultadosaep.client.esproj`).
